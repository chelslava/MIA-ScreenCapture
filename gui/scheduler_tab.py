...
from scheduler.task_scheduler import ScheduleType, ScheduleTask, RecordingParams
...
class TaskDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self.duration_spin.setSuffix(" секунд")
        self.duration_spin.setSpecialValueText("Без ограничения")
        params_layout.addRow("Длительность:", self.duration_spin)
    ...
    def _on_type_changed(self, index: int) -> None:
        ...
        self.time_edit.setVisible(is_daily or is_weekly)
