...
ПРИМЕЧАНИЕ: Эти тесты требуют реального PyQt6 для корректной работы.
Мокирование PyQt6 не обеспечивает полную эмуляцию Qt фреймворка.
"""

import pytest

# Пропускаем все тесты в этом модуле, так как мокирование PyQt6 недостаточно
pytestmark = pytest.mark.skip(
    reason="GUI тесты требуют реального PyQt6. Мокирование не обеспечивает полную эмуляцию Qt."
)
