...
# ============================================================================
# Ошибки очереди команд и backpressure
# ============================================================================


class CommandQueueError(MIAError):
    """Базовая ошибка очереди команд."""

    pass


class CommandQueueFullError(CommandQueueError):
    """Очередь команд переполнена (достигнут лимит backpressure)."""

    pass


class CommandTimeoutError(CommandQueueError):
    """Таймаут выполнения команды в очереди."""
...
class ApplicationLifecycleError(MIAError):
    """Базовая ошибка жизненного цикла приложения."""

    pass


class AnotherInstanceRunningError(ApplicationLifecycleError):
