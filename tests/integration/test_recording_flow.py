...
class TestVideoRecorderIntegration:
    ...
    def test_capture_area_from_rect(self):
        ...
        with patch('recorder.video_recorder.validate_rect_coords') as mock_validate:
    ...
    def test_capture_area_from_window(self):
        ...
        with patch('recorder.video_recorder.get_available_windows') as mock_windows:
            mock_windows.return_value = [
                {'title': 'Test Browser', 'x': 0, 'y': 0, 'width': 1920, 'height': 1080}
            ]
...
class TestAudioRecorderIntegration:
    ...
    def test_audio_recorder_get_devices(self):
        ...
        with patch('recorder.audio_recorder.get_audio_devices') as mock_devices:
