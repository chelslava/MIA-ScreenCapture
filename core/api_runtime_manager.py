...
class ApiRuntimeManager:
    ...
    def setup_api_callbacks(self) -> None:
        ...
        server.set_callback("monitors", facade.get_monitors)
        ...
        server.set_callback("get_profiles", facade.get_profiles)
        server.set_callback("get_profile", facade.get_profile)
        server.set_callback("create_profile", facade.create_profile)
        server.set_callback("update_profile", facade.update_profile)
        server.set_callback("delete_profile", facade.delete_profile)
