...
class TestTaskSchedulerFullCycle:
    ...
    def test_enable_disable_task(
        ...
        try:
            ...
            assert result is True
            assert scheduler_with_callback._tasks['toggle-test'].enabled is False
            
            # Включение
            result = scheduler_with_callback.enable_task('toggle-test', True)
            assert result is True
            assert scheduler_with_callback._tasks['toggle-test'].enabled is True
...
class TestTaskSchedulerTriggers:
    ...
    def test_interval_trigger(
        ...
        try:
            ...
            assert scheduler_with_callback._tasks['interval-trigger'].enabled is True
...
class TestTaskSchedulerEdgeCases:
    ...
    def test_add_duplicate_task(
        ...
        try:
            ...
            assert scheduler_with_callback._tasks['duplicate'].name == 'Original'
