...
### Planned for 1.4.4
- Стабилизация API lifecycle в GUI (без регрессий в `start/stop/restart`)
- Проверка и фиксы для live-логов API (ротация/пустой файл/перезапуск)
- Улучшение user-facing ошибок во вкладке API
- Добавление тестов для API runtime управления и API-вкладки
- Снижение mypy-ошибок в затронутых модулях
