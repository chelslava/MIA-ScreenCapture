...
├──────────┬───────────────────────────────────────────────────────┤
│ 📹 Запись│  🎯 Весь экран  🪟 Окно  📐 Область                  │
│ ⚙️ Настройки│  ┌─────────────────────────────────────────────┐  │
│ 📅 Планировщик│  │ Превью: оверлей выбора области             │  │
│ 📡 API    │  │ (визуализация области захвата в реальном времени) │
│ 🔍 Диагностика│  │                                             │  │
│           │  └─────────────────────────────────────────────┘  │
│           │  ▶ Старт   ⏸ Пауза   ⏹ Стоп                       │
│           │  Длительность: 00:00:15  Статус: Запись...        │
│           │                                                   │
│           │  [Последние записи]                              │
│           │  ✓ 2026-06-24_150530.mp4 (2:34)                  │
│           │  ✓ 2026-06-24_143012.mp4 (5:12)                  │
└──────────┴───────────────────────────────────────────────────────┘
  Системный трей: ▶ ◆ (индикатор записи)
```
